...
export const Navbar: React.FC<NavbarProps> = ({ onSave, onOpenDocs }) => {
  ...
  return (
    <header className="w-full flex items-center justify-between px-6 sm:px-8 py-4 bg-[#0b0f19]/90 backdrop-blur-xl border-b border-slate-800/80 sticky top-0 z-50 shadow-2xl shadow-black/40">
      <div className="flex items-center gap-3.5 group cursor-pointer">
        ...
        <div>
          ...
          <p className="text-[10px] text-cyan-400/90 font-bold tracking-[0.3em] uppercase drop-shadow-[0_0_8px_rgba(34,211,238,0.25)]">
            Pathfinding Studio
          </p>
        </div>
      </div>
