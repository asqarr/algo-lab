...
export const AlgorithmDocsModal: React.FC<AlgorithmDocsModalProps> = ({
  ...
  const docsData = {
    ...
    aStar: {
      ...
      icon: <Zap className="w-4 h-4 sm:w-5 sm:h-5 text-emerald-400" />,
      description:
    ...
    bidirectional: {
      ...
      icon: <GitCommit className="w-4 h-4 sm:w-5 sm:h-5 text-purple-400" />,
      description:
    ...
    jps: {
      ...
      icon: <FastForward className="w-4 h-4 sm:w-5 sm:h-5 text-amber-400" />,
      description:
    ...
    duel: {
      ...
      icon: <Trophy className="w-4 h-4 sm:w-5 sm:h-5 text-indigo-400" />,
      description:
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 overflow-y-auto">
          ...
          <motion.div
            ...
            className="relative w-full max-w-2xl bg-[#0b0f19] border border-slate-800/80 rounded-3xl shadow-2xl p-4 sm:p-7 overflow-hidden z-10 text-slate-300 my-auto max-h-[90vh] flex flex-col"
          >
            ...
            <div className="relative flex justify-between items-center mb-4 sm:mb-5 border-b border-slate-800/80 pb-3 sm:pb-4 shrink-0">
              <div className="flex items-center gap-2.5 sm:gap-3">
                <div className="p-2 sm:p-2.5 rounded-2xl bg-indigo-500/10 text-indigo-400 border border-indigo-500/20 shadow-inner">
            ...
            <div className="grid grid-cols-3 sm:grid-cols-5 gap-1.5 sm:gap-2 mb-4 sm:mb-6 shrink-0">
                ...
                (key) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex items-center justify-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-2 sm:py-2.5 rounded-xl text-[11px] sm:text-xs font-semibold transition-all duration-300 cursor-pointer border ${
                        isActive
            ...
            <div className="overflow-y-auto pr-1 space-y-4">
              <div className="bg-slate-900/70 border border-slate-800/80 rounded-2xl p-4 sm:p-5 mb-4 sm:mb-6 shadow-inner space-y-3 sm:space-y-4">
                <div className="flex items-center justify-between flex-wrap gap-2">
                  ...
                  <span
                    className={`text-[11px] sm:text-xs px-2.5 sm:px-3 py-0.5 sm:py-1 rounded-full border font-medium ${current.bgBadge}`}
                  >
                    {current.badge}
                  </span>
                </div>
                ...
                <div className="space-y-2 pt-2 border-t border-slate-800/80">
                  <span className="text-[11px] sm:text-xs font-semibold text-slate-400 tracking-wider uppercase">
                    Key Characteristics:
                  </span>
                ...
                <div className="flex items-center justify-between pt-3 border-t border-slate-800/80 text-xs">
                  ...
                  <span className="font-mono text-cyan-400 font-bold bg-slate-950/60 px-2.5 sm:px-3 py-1 rounded-lg border border-slate-800/50 text-[11px] sm:text-xs">
            ...
            <div className="flex justify-end pt-2 shrink-0">
              <button
                onClick={onClose}
                className="w-full sm:w-auto px-7 py-2.5 sm:py-3 font-bold text-xs sm:text-sm text-white transition-all duration-300 bg-linear-to-r from-blue-600 via-indigo-600 to-cyan-500 hover:from-blue-500 hover:to-cyan-400 rounded-xl hover:shadow-lg hover:shadow-cyan-500/25 active:scale-95 cursor-pointer border border-white/10"
              >
                Got it
              </button>
            </div>
