        ...
        {isHelpOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="flex flex-col gap-3 text-sm leading-relaxed mb-6 text-slate-400 max-h-[60vh] overflow-y-auto pr-1 no-scrollbar">
              ...
              <div className="flex justify-end">
                <button
                  onClick={() => setIsHelpOpen(false)}
                  className="w-full py-3 font-bold text-white transition-all bg-linear-to-r from-amber-500 via-orange-500 to-amber-600 rounded-2xl hover:scale-[1.01] hover:shadow-lg hover:shadow-amber-500/25 active:scale-[0.98] cursor-pointer shadow-md"
                >
